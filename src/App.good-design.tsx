...
function App() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-blue-100 to-indigo-200">
      <Document
        file={pdfFile}
        onLoadSuccess={onDocumentLoadSuccess}
        className="pdf-document flex flex-col items-center justify-center w-full h-full"
        loading={
